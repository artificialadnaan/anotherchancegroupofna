  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2" data-testid="text-readings-heading">Daily Readings</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card className="hover-elevate" data-testid="card-jft">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg">Just for Today</CardTitle>
          ...
          <CardContent>
            ...
            <a href="https://www.jftna.org/jft/" target="_blank" rel="noopener noreferrer" data-testid="link-jft">
        ...
        <Card className="hover-elevate" data-testid="card-spad">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg">Spiritual Principle a Day</CardTitle>
                <p className="text-sm text-muted-foreground">Daily Meditation</p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <a href="https://www.spadna.org/spad/" target="_blank" rel="noopener noreferrer" data-testid="link-spad">
              <Button className="w-full">
                <BookOpen className="w-4 h-4 mr-2" />
                Read Today's SPAD
                <ExternalLink className="w-3 h-3 ml-2" />
      ...
      <section className="p-6 bg-muted/50 rounded-md">
        <h2 className="text-xl font-semibold mb-3">About Daily Readings</h2>

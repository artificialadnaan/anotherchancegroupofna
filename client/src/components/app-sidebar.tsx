import { Home, Clock, BookOpen, Users, CalendarDays, Mail, Settings, Cake, BookMarked, Sparkles } from "lucide-react";
...
const publicItems = [
  ...
  { title: "Daily Readings", url: "/daily-readings", icon: Sparkles },
